...
int main(int argc, char *argv[])
{
    ...
    *p_char = '\0';
    ...
    {
        l1 = simplification_bezier_2(cel_contour->l, 0, cel_contour->l.taille-1, distance_seuil);
        nb_bezier += l1.taille;
        temp = l1.first;
        B3 = elevation_bezier(temp->B);
